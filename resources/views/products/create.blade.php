        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('products.store') }}">
                    ...
                    <div class="mb-6">
                        <x-input-label for="stock_qty" value="Initial Stock" />
                        <x-text-input id="stock_qty" name="stock_qty" type="number" min="0" class="block mt-1 w-full" :value="old('stock_qty', 0)" required />
